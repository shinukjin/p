...
import { FiUser, FiLogOut, FiHome, FiHeart, FiMapPin, FiCamera, FiPackage, FiEdit3, FiTrendingUp } from 'react-icons/fi';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <FiHome className="w-8 h-8 text-primary-600 mr-3" />
        ...
        >
          ...
          <div className="card p-6 mb-8">
            ...
            <p className="text-gray-600">
              결혼 준비를 위한 정보를 체계적으로 관리해보세요. 식장, 스드메, 부동산 정보를 한 곳에서!
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">신혼집 후보지</p>
              <div className="mt-2 text-xs text-gray-500">
                북마크: 7개
              </div>
            </motion.div>
          ...
          >
            <h3 className="text-lg font-semibold text-gray-900 mb-4">API 연결 상태</h3>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
              <span className="text-green-600 font-medium">서버 연결됨</span>
            </div>
            <p className="text-gray-600 text-sm mt-2">
              백엔드 서버와 성공적으로 연결되어 있습니다.
            </p>
          </motion.div>
        </motion.div>
      </main>
