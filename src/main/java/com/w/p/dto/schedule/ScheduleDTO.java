...
public class ScheduleDTO {
    ...
    public static class Summary {
        ...
        public static Summary from(Schedule.ScheduleStatus status, long count) {
    ...
    public static class TypeSummary {
        ...
        public static TypeSummary from(Schedule.ScheduleType type, long count) {
            return TypeSummary.builder()
                    .type(type)
                    .count(count)
                    .build();
        }
